...
public class CacheClassDecorator {
    ...
    public static class CacheAdvisor {
        ...
        public static Object cache(
            ...
            CacheValue cacheExistingInCache = cache.get(cacheKey);
            if (cacheExistingInCache != null && isCacheNotExpired(cacheExistingInCache, method)) {
                return cacheExistingInCache.value;
            } else {
                return invokeRealMethodAndPutIntoCache(superCall, cacheKey);
            }
        }

        private static Object invokeRealMethodAndPutIntoCache(@SuperCall Callable<Object> superCall, CacheKey cacheKey)
                throws Exception {
        ...
        private static Boolean isCacheNotExpired(CacheValue cacheValue, Method method) {
