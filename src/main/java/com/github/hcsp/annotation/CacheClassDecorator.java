...
public class CacheClassDecorator {
    ...
    public static class CacheAdvisor {
        ...
        private static Object invokeRealMethodAndPutIntoCache(@SuperCall Callable<Object> superCall,
            ...
            Object methodInvocationResult = superCall.call();
            cache.put(cacheKey, new CacheValue(methodInvocationResult, System.currentTimeMillis()));
