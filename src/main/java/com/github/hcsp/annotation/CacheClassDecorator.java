...
public class CacheClassDecorator {
    ...
    public static class CacheAdvisor {
        ...
        public static Object cache(
                @SuperCall Callable<Objects> superCall,
            ...
            if (resultExistingInCache != null) {
                ...
                if (cacheExpired(resultExistingInCache, method)) {
                    return invokeRealMethodAndIntoCache(superCall, cacheKey);
                }
                return resultExistingInCache.value;
            } else {
                //相当于 method.invoke(thisObject,arguments);
                return invokeRealMethodAndIntoCache(superCall, cacheKey);
            }
        }

        private static Object invokeRealMethodAndIntoCache(@SuperCall Callable<Objects> superCall,
        ...
        private static boolean cacheExpired(CacheValue cacheValuee, Method method) {
            long time = cacheValuee.time;
