...
CacheClassDecorator {
    ...
    public static class CacheAdvisor {
        ...
        private static Object invokeRealMethodAndPutIntoCache(@SuperCall Callable<Object> superCall,
            ...
            Object realMethodInvokeResult = superCall.call();
            cache.put(cacheKey, new CacheValue(realMethodInvokeResult, System.currentTimeMillis()));
            return realMethodInvokeResult;
        }
