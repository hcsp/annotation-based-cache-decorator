...
public class CacheClassDecorator {
    ...
    public static class CacheAdvisor {
        ...
        public static Object cache(
            ...
            final CacheValue alreadyExistResult = cache.get(cacheKey);

            if (alreadyExistResult != null) {
                if (cacheExpired(alreadyExistResult, method)) {
                    return invokedRealMethodAndPutIntoCache(superCall, cacheKey);
                } else {
                    return alreadyExistResult.object;
                }
            } else {
                return invokedRealMethodAndPutIntoCache(superCall, cacheKey);
            }
        ...
        private static Object invokedRealMethodAndPutIntoCache(@SuperCall Callable<Object> superCall, CacheKey cacheKey) throws Exception {
            Object realMethodResult = superCall.call();
