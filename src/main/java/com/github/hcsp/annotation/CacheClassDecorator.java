...
public class CacheClassDecorator {
    ...
    // 注意，缓存的实现需要是线程安全的
    static List<String> methodWithCache = Stream.of(DataService.class.getMethods()).filter(method -> method.getAnnotation(Cache.class) != null).map(Method::getName).collect(Collectors.toList());
